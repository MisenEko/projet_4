...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 25, 2020 at 02:37 PM
...
CREATE TABLE IF NOT EXISTS `comments` (
  ...
  `report_tag` int(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
...
INSERT INTO `comments` (`id`, `author`, `content`, `id_post`, `comment_date`, `report_tag`) VALUES
(2, 'test', 'et un test sur le premier commentaire niveau édition', 1, '2020-03-17 11:46:53', 0),
(3, '123', 'et un commentaire', 1, '2020-03-17 11:47:12', 0),
(6, 'ajout123', 'test de commentaire après avoir changé le code 2', 1, '2020-03-18 14:37:12', 1),
(7, 'test', 'test', 1, '2020-03-21 13:28:07', 0);
...
(2, 'Forteroche', 'blablablablabla', '2020-03-21 15:50:36', 'un titre', 'un exemple'),
(6, 'Forteroche', '<p>et un exemple de contenu.</p>', '2020-03-21 17:18:45', 'Un superbe titre', '<p>Un exemple d\'extrait</p>');
